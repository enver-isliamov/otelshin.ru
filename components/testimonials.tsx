  ...
  const testimonials = [
    {
      name: "Денис Грошев",
      text: "Чёткий сервис!
Нужно было где-то хранить шины после переезда в Симферополь. Нашел это объявление, быстро договорились по условиям. Энвер подъехал по адресу, на месте заключили договор, отдал шины. По окончании срока договора забрал шины в целости и сохранности. Рекомендую!",
      rating: 5,
