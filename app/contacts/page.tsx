    ...
    <div className="py-12 lg:py-20">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-12 lg:mb-16">
          <h1 className="text-3xl lg:text-5xl font-bold text-gray-900 mb-4 lg:mb-6">Контакты</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
          ...
          <div className="bg-white rounded-xl p-6 lg:p-8 shadow-lg border border-gray-100">
            ...
            <p className="text-gray-600 mb-6">Поможем выбрать тариф и рассчитаем стоимость</p>
          ...
          <div className="space-y-6">
            <div className="bg-gradient-to-br from-blue-50 to-purple-50 rounded-xl p-6 lg:p-8">
              <h3 className="text-xl font-bold text-gray-900 mb-4">Почему стоит выбрать CarMan?</h3>
            ...
            <div className="bg-white rounded-xl p-6 shadow-md border border-gray-100">
              <h3 className="text-lg font-bold text-gray-900 mb-4">Быстрая связь</h3>
