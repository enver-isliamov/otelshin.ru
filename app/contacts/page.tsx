...
export const metadata: Metadata = {
  ...
  description:
    "Свяжитесь с OtelShin для хранения шин в Симферополе. ☎️ +7 (978) 070-36-65, Telegram @EnrikeTomas. Работаем ежедневно 9:00-22:00. Выезжаем по всему городу.",
  ...
  openGraph: {
    ...
    description: "Свяжитесь с нами: ☎️ +7 (978) 070-36-65, Telegram @EnrikeTomas. Работаем ежедневно 9:00-22:00",
    type: "website",
    locale: "ru_RU",
    siteName: "OtelShin",
  },
