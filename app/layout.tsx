...
export const metadata: Metadata = {
  ...
  description:
    "Вывоз шин прямо от дома или офиса БЕСПЛАТНО. Стоимсоть от 500₽/месяц. Цена: ✓ R13-R15 ○ 500p ⚡ ✓ R16-R19 ○ 600р ⚡.  Доступ в личный кабинет. ☎️ +7 (978) 070-36-65 Решаем проблему хранения ваших Шин, Колес, Дисков, Резины, Покрышек в Симферополе ",
  keywords:
